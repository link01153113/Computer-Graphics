...
window.Cube2 = window.classes.Cube =
class Cube extends Shape    // A cube inserts six square strips into its arrays.
{ constructor()  
    { super( "positions", "normals", "texture_coords" );
      for( var i = 0; i < 3; i++ )                    
...
window.Cube3 = window.classes.Cube3 = 
class Cube3 extends Shape
{ constructor() 
  {
    super( "positions", "normals", "texture_coords");
      for( var i = 0; i < 3; i++ )                    
        ...
        { var square_transform = Mat4.rotation( i == 0 ? Math.PI/2 : 0, Vec.of(.5, 0, 0) )
          ...
          Square3.insert_transformed_copy_into( this, [], square_transform );
          var square_transform = Mat4.rotation( i == 0 ? Math.PI/2 : 0, Vec.of(.5, .5, 0) )
                         .times( Mat4.rotation( Math.PI * j - ( i == 1 ? Math.PI/2 : 0 ), Vec.of( 0, .5, 0 ) ) )
                         .times( Mat4.translation([ 0, .5, 0 ]) );
          Square3.insert_transformed_copy_into( this, [], square_transform );
          var tex =  [[ .34,.66 ], [ 0,0 ]];
          Axis_Arrows.insert_transformed_copy_into( this, [ 3, 8, tex ] );
        }
  }
}
